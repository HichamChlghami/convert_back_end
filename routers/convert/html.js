...
// const scriptPath = path.join(__dirname, '../../python/convert/html_file.py');

// router.post('/html', upload.array('files'), async (req, res) => {
//     try {
...
// router.get('/progressHtml', (req, res) => {
...
router.post('/html', upload.single('chunk'), async (req, res) => {
