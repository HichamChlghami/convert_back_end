...
// const scriptPath = path.join(__dirname, '../../python/convert/imagesDocx.py');

// router.post('/imagesDocx', upload.array('files'), async (req, res) => {
//     try {
...
// router.get('/progressImageDocx', (req, res) => {
...
router.post('/imagesDocx', upload.single('chunk'), async (req, res) => {
