...
// const scriptPath = path.join(__dirname, '../../python/convert/images_svg.py');

// router.post('/images_svg', upload.array('files'), async (req, res) => {
//     try {
...
//                     console.log('Executing Python script1');
...
// router.get('/progressImage', (req, res) => {
...
router.post('/images_svg', upload.single('chunk'), async (req, res) => {
