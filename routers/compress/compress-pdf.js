...
// const scriptPath = path.join(__dirname, '../../python/compress/compress-pdf.py');

// router.post('/CompressPdf', upload.array('files'), async (req, res) => {
//     try {
...
// router.get('/progressCompressPdf', (req, res) => {
...
router.post('/CompressPdf', upload.single('chunk'), async (req, res) => {
